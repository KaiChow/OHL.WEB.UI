...
This is the project-level UI delivery contract for `FE.OHL.WEB.UI`.

Synced copies: `.cursor/skills/freight-arco-ui/`, `.agents/skills/freight-arco-ui/`, `.claude/skills/freight-arco-ui/` (run `npm run sync-ui-skill` after editing this source).
