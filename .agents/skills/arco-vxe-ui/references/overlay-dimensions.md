...
At `1024x768`, `1366x768`, widescreen (≥ 1440px), and 200% browser zoom:
...
- `height="auto"` on an embedded VXE table inside a Drawer or intrinsic-height pane — or in a page-level scrolling section; use a fixed height or max-height instead.
