...
export const PROFIT_REVIEW_SPEC = definePesdpPageSpec({
  ...
  pesdp: {
    ...
    dense: { decisions: ['Use S1 inline query with five conditions, the shared vertical-form label rhythm, and VXE global mini density in both supported locales.'], acceptance: ['At 1366x768 and 1024x768 the table remains dominant, the label-to-control gap resolves to 4px, and no command band wraps in zh-CN or en-US.'] },
