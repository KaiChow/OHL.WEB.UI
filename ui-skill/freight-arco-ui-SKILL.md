...
.vxe-table .vxe-body--row { height: var(--dense-row-h); } /* 40px 默认 */
...
| `.table-card-cap__summary` | 「共 N 条」文案 | F2 | `--dense-font-nav` + text-3 | 13 |
| `.table-card-cap__summary b` | 条数数字 | F1 | `--dense-font-data` | 13 |
